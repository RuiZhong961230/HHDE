...
def RunHHDE(func):
    ...
    np.savetxt("./HHDE_Data/CEC2022/F" + str(Func_num) + "_" + str(DimSize) + "D.csv", All_Trial_Best, delimiter=",")
...
def main(dim):
    ...
    CEC2022 = [cec2022.F12022(dim), cec2022.F22022(dim), cec2022.F32022(dim), cec2022.F42022(dim), cec2022.F52022(dim),
               cec2022.F62022(dim), cec2022.F72022(dim), cec2022.F82022(dim), cec2022.F92022(dim), cec2022.F102022(dim),
               cec2022.F112022(dim), cec2022.F122022(dim)]
...
if __name__ == "__main__":
    if os.path.exists('./HHDE_Data/CEC2022') == False:
        os.makedirs('./HHDE_Data/CEC2022')
    Dims = [10, 20]
    for Dim in Dims:
        main(Dim)
